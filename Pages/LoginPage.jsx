    ...
    return (
        ...
        <main>
            <form action="">
                ...
                <button className="primary-btn" onClick={props.login}>Continue <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <footer>
            <a href="#" className="links footer__password">Forgot password</a>
